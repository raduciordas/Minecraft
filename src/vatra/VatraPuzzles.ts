...
export const VATRA_PUZZLES: Record<string, VatraPuzzle> = {
  ...
  iedul_pe_creasta: {
    ...
    intro:
      'MOȘ CĂLIMAN: „A treia potecă are paisprezece porunci. Pistrui pornește de pe lespedea albă privind înainte. Urmărește singur pietrele până la cea aurie și alege fiecare pas sau întoarcere."',
  ...
  iedul_la_sare: {
    id: 'iedul_la_sare',
    title: 'Drumul sării — șaptesprezece comenzi',
    intro:
      'MOȘ CĂLIMAN: „Drumul sării are șaptesprezece porunci și nu cere niciun pas înapoi. Citește singur lespezile, de la cea albă la cea aurie, și construiește secvența potrivită."',
    success: 'Pistrui a găsit sarea muntelui urmând întregul traseu! (+10 sare de stâncă)',
    ...
    solution: [
      ...
      A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('stanga'), A('inainte'), A('inainte'),
      A('dreapta'), A('inainte'), A('inainte'),
    ],
    fails: [{ text: 'Pistrui a ratat bulgărele de sare. Urmărește lespezile din nou și verifică fiecare cot.', anim: 'none', matches: () => true }],
  },
  iedul_la_refugiu: {
    id: 'iedul_la_refugiu',
    title: 'Drumul refugiului — douăzeci de comenzi',
    intro:
      'MOȘ CĂLIMAN: „Urmează poteca lungă spre refugiu. Sunt douăzeci de porunci; citește singur lespezile pe porțiuni și calculează fiecare schimbare de direcție."',
    ...
    solution: [
      A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('dreapta'),
      A('inainte'), A('inainte'), A('inainte'), A('stanga'), A('inainte'), A('inainte'),
      A('inainte'), A('inainte'), A('stanga'), A('inainte'), A('inainte'), A('inainte'),
      A('dreapta'), A('inainte'),
    ],
    fails: [{ text: 'Refugiul e aproape, dar o întoarcere e în locul greșit. Recitește traseul în grupuri de câte patru sau cinci lespezi.', anim: 'none', matches: () => true }],
  },
  iedul_la_clopot: {
    id: 'iedul_la_clopot',
    title: 'Drumul clopotului — secvența cea mare',
    intro:
      'MOȘ CĂLIMAN: „Ultimul drum are douăzeci și patru de porunci. Citește singur poteca până la clopot și folosește doar mersul înainte și întoarcerile."',
    ...
    solution: [
      A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('inainte'),
      A('dreapta'), A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('stanga'),
      A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('inainte'), A('stanga'),
